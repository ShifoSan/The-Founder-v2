...
# For now, commands will check for the Administrator permission natively.

WELCOME_CHANNEL_ID = 1423316345252089998
LEAVE_CHANNEL_ID = 1407852575620993055

ANNOUNCE_THUMBNAIL_URL = "PLACEHOLDER_URL_HERE"
...
# Set of banned words. User will paste them here.
BANNED_WORDS = {
    # Paste banned words here
}
